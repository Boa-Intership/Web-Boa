    ...
    switch (openModal) {
        ...
        return {
          ...
          example: [
            ...
            },
            {
              ...
              description:
                'Detergentes, jabones, desinfectantes (no peligrosos)',
      ...
      case 'perecederos':
        return {
          title: 'Perecederos',
          description:
            'La categoría perecederos son aquellos productos que tienen una vida útil limitada y que requieren condiciones especiales de temperatura, humedad o manejo para evitar su deterioro durante el transporte.',
          subtitle: 'Requisitos',
          details: [
            {
              title: '',
        ...
        return {
          ...
          example: [
            ...
            },
            {
              ...
              description:
                'Restos cremados transportados en urnas funerarias adecuadas.',
        ...
        return {
          ...
          example: [
            ...
            },
            {
              ...
              description:
                'muestras para diagnosticos, sustancias toxicas o infecciosas y herbicidas',
            ...
            },
            {
              ...
              description:
                'acidos alcalinos, mercurio, pilas humedas, peroxidos,acumuladores electricos',
    ...
    <Box>
      <Box display="flex" alignContent={'start'} flexWrap="wrap" gap={2} mt={8}>
        ...
        <Typography variant="body1" color={'#2D2D2D'}>
          Conoce los tipos de carga <strong>Permitidas</strong> y{' '}
          <strong>No Permitidas</strong> que puedes enviar a través de nuestro
          servicio de paquetería aérea y las restricciones aplicables.
        </Typography>
        <Grid
          container
          spacing={4}
