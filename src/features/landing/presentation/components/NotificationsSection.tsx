...
import { Divider, Card, CardContent, CardActions, Collapse, IconButton, Box } from '@mui/material';
...
const NotificationsSection: React.FC = () => {
  ...
  return (
    <AppBox sx={{ py: { xs: 6, md: 10 }, background: 'background.paper' }}>
      <AppContainer>
        <AppTypography variant="h4Bold" mb={2} textAlign="center">
            ...
            <AppGrid item xs={12} sm={6} md={4} key={notif.id}>
              ...
              >
                <CardContent>
                  ...
                  <AppTypography variant="h4Regular" color="text.secondary" mb={1}>
                    {notif.description}
                  </AppTypography>
                  <AppTypography variant="h4Regular" color="grey.600">
                    {notif.date}
                  </AppTypography>
                </CardContent>
